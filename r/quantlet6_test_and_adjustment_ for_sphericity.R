...
sphericity_table = data.frame("Source" = "Factor",
                            "Mauchly's W" = w,
                            "Chi square" = chi_sq_w,
                            "df" = df_w,
                            "p" = p_w,
                            "Lower-Bound correction (Greenhouse-Geisser)" = epsilon_lb,
                            "Box correction (Greenhouse-Geisser)" = epsilon_gg,
                            "Huynh-Feldt correction (Huynh-Feldt)" = epsilon_hf
)
rownames(sphericity_table) = NULL
...
corrected_p_value_table = data.frame("Source" = c("Epsilon", "Adjusted p-Value"),
                                     "Lower-Bound correction (Greenhouse-Geisser)" = c(epsilon_lb, p_factor_lb),
                                     "Box correction (Greenhouse-Geisser)" = c(epsilon_gg, p_factor_gg),
                                     "Huynh-Feldt correction (Huynh-Feldt)" = c(epsilon_hf, p_factor_hf)
)
rownames(sphericity_table) = NULL
